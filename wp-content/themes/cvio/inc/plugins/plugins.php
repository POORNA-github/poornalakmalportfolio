...
function cvio_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			...
			'slug'		=> 'cvio-plugin',
			'source'	=> CVIO_EXTRA_PLUGINS_DIRECTORY . '/normal/cvio-plugin/201223/' . 'cvio-plugin.zip',
			'required'	=> true,
			'version'	=> '3.3.1',
		),
	...
	if ( class_exists( 'CvioPlugin' ) ) {
		$plugins[] = array(
			...
			'source'				=> CVIO_EXTRA_PLUGINS_DIRECTORY . '/normal/acf/071223/' . 'advanced-custom-fields-pro.zip',
			'required'				=> true,
			'version'				=> '6.2.4',
		);
	}
