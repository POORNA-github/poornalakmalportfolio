...
class Cvio_Started_Section_Widget extends Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			'tspeed',
			[
				'label' => esc_html__( 'Typed Speed', 'cvio-plugin' ),
				'type'        => Controls_Manager::TEXT,
				'placeholder' => esc_html__( '100', 'cvio-plugin' ),
				'default'	=> esc_html__( '100', 'cvio-plugin' ),
				'condition' => ['under_title' => 'subtitles']
			]
		);
		...
		$this->add_control(
			'tdelay',
			[
				'label' => esc_html__( 'Typed Back Delay', 'cvio-plugin' ),
				'type'        => Controls_Manager::TEXT,
				'placeholder' => esc_html__( '500', 'cvio-plugin' ),
				'default'	=> esc_html__( '500', 'cvio-plugin' ),
				'condition' => ['under_title' => 'subtitles']
			]
		);
				...
				<div class="vertical-center">
					<div class="started-content">
						...
						<div class="h-subtitles">
							...
							<span class="typed-subtitle" data-tspeed="<?php echo esc_attr( $settings['tspeed'] ); ?>" data-tdelay="<?php echo esc_attr( $settings['tdelay'] ); ?>"></span>
						</div>
						<?php endif; ?>
...
Plugin::instance()->widgets_manager->register( new Cvio_Started_Section_Widget() );
