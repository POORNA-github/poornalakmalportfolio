  ...
  public $slug = 'cvio';
    ...
    function activated_form_content(){
        ...
        <div class="cvio-dashboard-activation">
          ...
          <form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>">
            ...
            <div class="cvio-dashboard-list">
              ...
              <div class="buttons">
                ...
                <a href="<?php echo esc_url( admin_url( 'admin-post.php' ) . '?action=cvio_fupc' ); ?>" class="button button-link">
                  <?php echo esc_html__( 'Check Updates', 'cvio-plugin' ); ?>
                </a>
          ...
          <p style="margin-top: 30px;"><strong><?php echo sprintf( __( 'Manage Your License', 'cvio-plugin' ) ); ?></strong></p>
          <div class="notice notice-info">
            <p><?php echo sprintf( __( 'To manage all your activation, please, register an account and login on <a href="https://licenses.bslthemes.com/" target="_blank">Bslthemes License Manager</a> using your already registered email and purchase code.', 'cvio-plugin' ) ); ?></p>
          </div>
        </div>
    <?php
    }
